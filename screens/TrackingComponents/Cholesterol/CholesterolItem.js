...
const CholesterolItem = ({ list, handleDelete, reload }) => {
  ...
  return (
    <>
            <View style={styles.itemContainer}>
                <Box width={"85%"}>
                    <TouchableOpacity onPress={() => confirmEdit()}>
                        <HStack>
                            <Text style={styles.itemBold}>Colesterol: </Text>
            ...
            <ModalScreen3 isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} description={'Editar Registro Colesterol'}>
                <CholesterolRegister isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} reload={reload} editing={true} list={list} />
            </ModalScreen3>
        </>
  )
}

export default CholesterolItem
