...
import { editCholesterol, postCholesterol } from '../../../util/api/tracking'

const CholesterolRegister = ({ isModalOpen, setisModalOpen, reload, editing, list }) => {
    ...
    const handleSubmit = async () => {
        try {
            if (!editing) {
                ...
                await editCholesterol(objectWithID);
                reload();
  ...
  return (
    <View style={styles.main}>
            <Text style={styles.modalText}>Colesterol:</Text>
            <Input
                textAlign={'center'}
                value={weight.value}
...
export default CholesterolRegister
