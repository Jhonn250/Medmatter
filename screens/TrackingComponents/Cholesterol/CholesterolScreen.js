...
import { getCholesterol, deleteCholesterol } from "../../../util/api/tracking.js";
import CholesterolItem from "./CholesterolItem.js";
import CholesterolRegister from "./CholesterolRegister.js";
...
const CholesterolScreen = () => {
    ...
    const deleteConfirmation = async (id) => {
        const res = await deleteCholesterol(id);
    ...
    const renderItem = ({ item }) => {
        return <CholesterolItem list={item} handleDelete={handleDelete} reload={reload} />;
    };
    ...
    return (
        <Layout>
            ...
            <HStack>
                ...
                <Text style={{ fontFamily: "RBold", fontSize: 20, marginBottom: '10%', marginLeft: '3%' }}>Colesterol</Text>
            </HStack>
            ...
            <ModalScreen3 isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} description={'Nuevo Registro Colesterol'}>
                <CholesterolRegister isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} reload={reload} />
            </ModalScreen3>
        </Layout >
    );
};
