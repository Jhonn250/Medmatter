...
const WeightItem = ({ list, handleDelete, reload }) => {
    ...
    return (
        <>
            ...
            <ModalScreen3 isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} description={'Editar Peso'}>
                <WeightRegister isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} reload={reload} editing={true} list={list} />
            </ModalScreen3>
        </>
