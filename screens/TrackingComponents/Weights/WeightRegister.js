...
import { editWeigth, postWeight } from '../../../util/api/tracking'

const WeightRegister = ({ isModalOpen, setisModalOpen, reload, editing, list }) => {
