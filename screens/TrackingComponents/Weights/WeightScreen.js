...
import { getWeight, deleteWeight } from "../../../util/api/tracking.js";
import WeightRegister from "./WeightRegister.js";
...
const WeightScreen = () => {
    ...
    const renderItem = ({ item }) => {
        return <WeightItem list={item} handleDelete={handleDelete} reload={reload} />;
    };
    ...
    return (
        <Layout>
            ...
            <HStack>
                <Icon name="weight" size={30} />
                <Text style={{ fontFamily: "RBold", fontSize: 20, marginBottom: '10%', marginLeft: '3%' }}>Peso</Text>
            </HStack>
            ...
            <ModalScreen3 isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} description={'Nuevo Peso'}>
                <WeightRegister isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} reload={reload} />
            </ModalScreen3>
        </Layout >
    );
};
