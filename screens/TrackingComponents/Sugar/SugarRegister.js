...
import { Button, Center, Input, Box, ScrollView } from 'native-base'
import { getFixedDate } from '../../../util/other/GetFormattedDate'
import DateTimePickerModal from "react-native-modal-datetime-picker";
import { editGlycemia, postGlycemia } from '../../../util/api/tracking'

const SugarRegister = ({ isModalOpen, setisModalOpen, reload, editing, list }) => {
    ...
    const handleSubmit = async () => {
        try {
            if (!editing) {
                ...
                await editGlycemia(objectWithID);
                reload();
  ...
  return (
    <View style={styles.main}>
            <Text style={styles.modalText}>Glucosa</Text>
            <Input
                textAlign={'center'}
                value={weight.value}
