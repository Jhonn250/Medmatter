...
import { getGlycemia, deleteGlycemia } from "../../../util/api/tracking.js";
...
import SugarItem from "./SugarItem.js";
...
const SugarScreen = () => {
    ...
    const deleteConfirmation = async (id) => {
        const res = await deleteGlycemia(id);
    ...
    const renderItem = ({ item }) => {
        return <SugarItem list={item} handleDelete={handleDelete} reload={reload} />;
    };
    ...
    return (
        <Layout>
            ...
            <HStack>
                <Icon name="spoon-sugar" size={30} />
                <Text style={{ fontFamily: "RBold", fontSize: 20, marginBottom: '10%', marginLeft: '3%' }}>Azúcar (glucosa)</Text>
            </HStack>
            ...
            <ModalScreen3 isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} description={'Nuevo Nivel de Azúcar'}>
                <SugarRegister isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} reload={reload} />
            </ModalScreen3>
