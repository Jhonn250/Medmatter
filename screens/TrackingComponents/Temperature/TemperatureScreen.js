...
import { getTemperature, deleteTemperature } from "../../../util/api/tracking.js";
...
const TemperatureScreen = () => {
    ...
    const deleteConfirmation = async (id) => {
        const res = await deleteTemperature(id);
    ...
    const renderItem = ({ item }) => {
        return <TemperatureItem list={item} handleDelete={handleDelete} reload={reload} />;
    };
    ...
    return (
        <Layout>
            ...
            <HStack>
                ...
                <Text style={{ fontFamily: "RBold", fontSize: 20, marginBottom: '10%', marginLeft: '3%' }}>Temperatura</Text>
            </HStack>
            ...
            <ModalScreen3 isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} description={'Nuevo Registro Temperatura'}>
                <TemperatureRegister isModalOpen={isModalOpen} setisModalOpen={setisModalOpen} reload={reload} />
            </ModalScreen3>
        </Layout >
    );
};
