...
import { editBlood, postBlood } from '../../../util/api/tracking'

const BloodRegister = ({ isModalOpen, setisModalOpen, reload, editing, list }) => {
    ...
    return (
        <View style={styles.main}>
            <Text style={styles.modalText}>Presión Sistolica</Text>
            <Input
                textAlign={'center'}
                value={weight.value}
